...
for d in miter_group_*/; do
	...
	${MAKE:-make} -f ../../../../common/syn.mk YOSYS=../../../../../yosys SYN_COMMAND="synth_xilinx -run :coarse; clean" mul*.v
	${VERILATOR:-verilator} -Wno-initialdly -Wno-unoptflat -Wno-lint -Wno-combdly -CFLAGS "-O3" -o ../mul_tb -cc --top-module top --exe *.v ../../../../../techlibs/xilinx/cells_sim.v ../../../../common/verilator/miter_testbench.cc
